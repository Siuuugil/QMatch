...
이 프로젝트는 2025년 유한대학교 졸업작품 프로젝트입니다.
...
### 메인 페이지
<img src="img/mainPage.png" alt="메인 페이지" style="width:75%; border: 1px solid #ddd; border-radius: 5px; padding: 5px;">
...
이 프로젝트는 졸업작품 프로젝트입니다. 기여나 제안사항이 있으시면 이슈를 등록해주세요.

---

**QMatch** - 게이머를 위한 소통 플랫폼 🎮
