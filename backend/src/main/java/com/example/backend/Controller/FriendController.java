...
public class FriendController {
    ...
    @GetMapping("/list")
    public ResponseEntity<List<UserResponseDto>> getFriendsList(@RequestParam String userId) {
        try {
            List<UserResponseDto> friends = friendShipService.getFriendsList(userId);
