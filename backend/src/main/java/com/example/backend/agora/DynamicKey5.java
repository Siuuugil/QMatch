...
public class DynamicKey5 {
    ...
    public boolean fromString(String key) {
        ...
        com.example.backend.agora.ByteBuf buffer = new com.example.backend.agora.ByteBuf(rawContent);
    ...
    static class Message implements Packable {
        ...
        public com.example.backend.agora.ByteBuf marshal(com.example.backend.agora.ByteBuf out) {
    ...
    public static class DynamicKey5Content implements Packable {
        ...
        public void unmarshall(com.example.backend.agora.ByteBuf in) {
