...
public class RtcTokenBuilder {
    ...
    public String buildTokenWithUserAccount(String appId, String appCertificate, 
        ...
        com.example.backend.agora.AccessToken builder = new com.example.backend.agora.AccessToken(appId, appCertificate, channelName, account);
    	builder.addPrivilege(com.example.backend.agora.AccessToken.Privileges.kJoinChannel, privilegeTs);
    	if (role == Role.Role_Publisher || role == Role.Role_Subscriber || role == Role.Role_Admin) {
    		builder.addPrivilege(com.example.backend.agora.AccessToken.Privileges.kPublishAudioStream, privilegeTs);
    		builder.addPrivilege(com.example.backend.agora.AccessToken.Privileges.kPublishVideoStream, privilegeTs);
    		builder.addPrivilege(com.example.backend.agora.AccessToken.Privileges.kPublishDataStream, privilegeTs);
    	}
