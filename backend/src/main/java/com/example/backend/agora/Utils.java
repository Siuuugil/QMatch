...
public class Utils {
    ...
    public static byte[] pack(com.example.backend.agora.PackableEx packableEx) {
        com.example.backend.agora.ByteBuf buffer = new com.example.backend.agora.ByteBuf();
        packableEx.marshal(buffer);
        return buffer.asBytes();
    }

    public static void unpack(byte[] data, com.example.backend.agora.PackableEx packableEx) {
        com.example.backend.agora.ByteBuf buffer = new com.example.backend.agora.ByteBuf(data);
