...
function LobbyPage() {
  ...
  // State 보관함 해체
  const { isLogIn, setIsLogIn, userData, setUserData, setHasUnreadMessages, theme, toggleTheme, voiceParticipants: globalVoiceParticipants, setVoiceParticipants: setGlobalVoiceParticipants } = useContext(LogContext)
